...
From the box plot and the histogram of the cleaned dataset, we found that the protest
 rate is clustered around 0.006~0.007. To label the intensity of the protest rate, we decided to 
 use the 50th percentiles (0.005697) as a threshold to divide the intensity level. If the protest 
 rate of the city is less than 0.005697, the protest intensity of the city is mild. On the other 
 hand, the protest intensity of the city is intense. To ease the data processing, we label "mild" 
 as 0 and "intense" as 1.
"""
)
